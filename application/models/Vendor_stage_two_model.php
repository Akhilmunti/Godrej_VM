...
class Vendor_stage_two_model extends CI_Model {
    ...
    function __construct() {
        ...
        $this->table_parent = 'stage_two_vendor';
    }
    ...
    public function updateParentByVendorKey($param, $data) {
        $this->db->set($data);
        $this->db->where('stv_user_id', $param);
