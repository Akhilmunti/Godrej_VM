                                                ...
                                                <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">
                                                                <input name="pqc_first_score" type="number" id="first_score" class="form-control" />
                                                            </td>
                                                            <td rowspan="3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">
                                                                <input name="pqc_second_score" type="number" id="second_score" class="form-control" />
                                                            </td>
                                                            <td rowspan="3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">
                                                                <input name="pqc_third_score" type="number" id="third_score" class="form-control" />
                                                            </td>
                                                            <td rowspan="3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">
                                                                <input name="pqc_fourth_score" type="number" id="fourth_score" class="form-control" />
                                                            </td>
                                                            <td rowspan="3">
                                                        ...
                                                        <tr>
                                                            <td rowspan="5">5</td>
                                                            <td rowspan="5"> 
                                                                Telephonic feed back from existing client's represetatives. Referal check for track record at existing / completed projects. 
                                                                <br>
                                                                <i>Note: All the responses shall be kept on record by means of Email.</i>
                                                            </td> 
                                                            <td rowspan="5">20</td>
                                                            <td>Excellent : 20</td>
                                                            <td rowspan="5">
                                                            ...
                                                            <td rowspan="5">
                                                                <input name="pqc_fifth_score" type="number" id="fifth_score" class="form-control" />
                                                            </td>
                                                            <td rowspan="5">
