                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    <div class="box-body pb-0">
                                        ...
                                        <form method="POST" action="<?php echo base_url('buyer/vendor/actionSaveFeedbackForm/1/' . $mRecord['feedback_id']); ?>" enctype="multipart/form-data">
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly="" disabled="" value="<?php echo $mRecord['ff_vendor']; ?>" type="text" name="ff_vendor" class="form-control" />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['ff_date']; ?>" disabled="" value="" disabled="" type="date" name="ff_date" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly="" value="<?php echo $mRecord['ff_project']; ?>" disabled="" type="text" name="ff_project" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['ff_category']; ?>" disabled="" value="" disabled="" type="text" name="ff_category" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input value="<?php echo $mRecord['ff_time_period']; ?>" disabled="" type="text" class="form-control pull-right" name="ff_time_period" id="reservation">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>   
                                                ...
                                                <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select id="ff_one" name="ff_one" disabled="" class="form-control">
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" disabled="" type="number" class="form-control" value="<?php echo $mRecord['ff_one_marks']; ?>" name="ff_one_marks" id="ff_one_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_two" id="ff_two" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                                    if ($mRecord['ff_two'] == "1") {
                                                                        echo "selected";
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_two_marks']; ?>" disabled="" type="number" class="form-control" name="ff_two_marks" id="ff_two_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_three" id="ff_three" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_three_marks']; ?>" disabled="" type="number" class="form-control" name="ff_three_marks" id="ff_three_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_four" id="ff_four" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_four_marks']; ?>" disabled="" type="number" class="form-control" name="ff_four_marks" id="ff_four_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_five" id="ff_five" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_five_marks']; ?>" disabled="" type="number" class="form-control" name="ff_five_marks" id="ff_five_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_six" id="ff_six" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                                    if ($mRecord['ff_six'] == "1") {
                                                                        echo "selected";
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_six_marks']; ?>" disabled="" type="number" class="form-control" name="ff_six_marks" id="ff_six_marks" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select id="ff_seven" name="ff_seven" disabled="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_seven_marks']; ?>" disabled="" type="number" class="form-control" name="ff_seven_marks" id="ff_seven_marks" />
                                                            </td>
                                                            <td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input readonly="" disabled="" type="number" class="form-control" name="ff_final_score" id="ff_final_score" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="5">
