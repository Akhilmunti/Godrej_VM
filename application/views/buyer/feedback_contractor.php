                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    <div class="box-body pb-0">
                                        ...
                                        <form id="form" method="POST" action="<?php echo base_url('buyer/vendor/actionSaveFeedbackForm/3/' . $record['feedback_id']); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input readonly="" value="<?php echo $first_date . " - " . $last_date; ?>" required="" type="text" class="form-control pull-right" name="ff_time_period">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>   
        ...
        <script>
            ...
            $('#ff_eight').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_eight_marks_label').html("Enter 5");
                } else if (selected == "2") {
                    $("#ff_eight_marks").attr({
                        "max": 4,
                        "min": 2,
            ...
            function calculateTotal(val) {
                ...
                total = parseInt(first) + parseInt(second) + parseInt(third) + parseInt(fourth) + parseInt(fifth) + parseInt(sixth) + parseInt(seven) + parseInt(eight);
