        ...
        <script>
            ...
            $('#svrc_status').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_status_score_label').html("Enter Zero");
                }
            });
            ...
            $('#svrc_quality_mngmnt').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_quality_mngmnt_score_label').html("Enter Zero");
                }
            });
            ...
            $('#svrc_safety_mngmt').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_safety_mngmt_score_label').html("Enter Zero");
                    $('#svrc_final_recommendation').val("NoGo");
                    $('#svrc_final_recommendation').attr({
                        "readonly": "readonly",
                    });
