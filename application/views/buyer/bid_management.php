                                        ...
                                        <form id="register_form" action="<?php echo base_url('buyer/vendor/listApprovalBidders'); ?>" method="POST" class=" validation-wizard" enctype="multipart/form-data">
                                            ...
                                            <section>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Close Date for Query submission</label>
                                                            <input type="date" class="form-control" name="" id="" />
                                                        </div>
                                                    </div>
                                                    <!--                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Close Date for RFQ</label>
                                                            <input type="time" class="form-control" name="" id="" />
                                                        </div>
                                                    </div>
                                                </div>  
                                            ...
                                            <section>
                                                <div class="row">  
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <a href="#" data-toggle="modal" data-target="#modal-right-upload" class="btn btn-primary"> 
                                                            Upload BOQ Template
                                                        </a>
                                                    </div>
                                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a href="<?php echo base_url('assets/boq-upload.xlsx'); ?>" download="" class="btn btn-xs btn-primary">
                                Download Format
                            </a>
                        </div>
            ...
            function ProcessExcel(data) {
                ...
                for (var i = 0; i < excelRows.length; i++) {
                    ...
                    if (excelRows[i].location) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].location + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].unit) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].unit + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].basement) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].basement + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].tower_a) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].tower_a + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].tower_b) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].tower_b + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].tower_c) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].tower_c + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].rate) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].rate + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
                    ...
                    if (excelRows[i].amount) {
                        cell = $("<td />");
                        cell.html("<input value='" + excelRows[i].amount + "' class='form-control min-width-200'/>");
                        row.append(cell);
                    } else {
                        cell = $("<td />");
                        cell.html("");
