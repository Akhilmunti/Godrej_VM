                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    <div class="box-body pb-0">
                                        ...
                                        <form method="POST" action="<?php echo base_url('buyer/vendor/actionSaveFeedbackForm/2/' . $record['feedback_id']); ?>" enctype="multipart/form-data">
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly="" value="<?php echo $mRecord['ff_vendor']; ?>" type="text" name="ff_vendor" class="form-control" />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['ff_date']; ?>" readonly="" value="" readonly="" type="date" name="ff_date" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly="" value="<?php echo $mRecord['ff_project']; ?>" readonly="" type="text" name="ff_project" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select readonly class="form-control" readonly="" name="ff_category">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input value="<?php echo $first_date . " - " . $last_date; ?>" readonly="" type="text" class="form-control pull-right" name="ff_time_period" id="reservation">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>   
                                                ...
                                                <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_one" id="ff_one" readonly="" class="form-control">
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" readonly="" type="number" class="form-control" value="<?php echo $mRecord['ff_one_marks']; ?>" name="ff_one_marks" id="ff_one_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_one_remarks"><?php echo $mRecord['ff_one_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_two" id="ff_two" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                                    if ($mRecord['ff_two'] == "1") {
                                                                        echo "selected";
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_two_marks']; ?>" readonly="" type="number" class="form-control" name="ff_two_marks" id="ff_two_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_two_remarks"><?php echo $mRecord['ff_two_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_three" id="ff_three" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_three_marks']; ?>" readonly="" type="number" class="form-control" name="ff_three_marks" id="ff_three_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_three_remarks"><?php echo $mRecord['ff_three_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_four" id="ff_four" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_four_marks']; ?>" readonly="" type="number" class="form-control" name="ff_four_marks" id="ff_four_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_four_remarks"><?php echo $mRecord['ff_four_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_five" id="ff_five" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_five_marks']; ?>" readonly="" type="number" class="form-control" name="ff_five_marks" id="ff_five_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_five_remarks"><?php echo $mRecord['ff_five_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_six" id="ff_six" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                                    if ($mRecord['ff_six'] == "1") {
                                                                        echo "selected";
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_six_marks']; ?>" readonly="" type="number" class="form-control" name="ff_six_marks" id="ff_six_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_six_remarks"><?php echo $mRecord['ff_six_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_seven" id="ff_seven" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_seven_marks']; ?>" readonly="" type="number" class="form-control" name="ff_seven_marks" id="ff_seven_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_seven_remarks"><?php echo $mRecord['ff_seven_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_eight" id="ff_eight" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_eight_marks']; ?>" readonly="" type="number" class="form-control" name="ff_eight_marks" id="ff_eight_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_eight_remarks"><?php echo $mRecord['ff_eight_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ff_nine" id="ff_nine" readonly="" class="form-control">
                                                                    <option disabled="" selected="" value="">Select</option>
                                                                    <option <?php
                                                                    if ($mRecord['ff_eight'] == "1") {
                                                                        echo "selected";
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input onchange="calculateTotal(this.value)" value="<?php echo $mRecord['ff_nine_marks']; ?>" readonly="" type="number" class="form-control" name="ff_nine_marks" id="ff_nine_marks" />
                                                            </td>
                                                            <td>
                                                                <textarea readonly="" class="form-control" rows="4" name="ff_nine_remarks"><?php echo $mRecord['ff_nine_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input readonly="" readonly="" type="number" class="form-control" name="ff_final_score" id="ff_final_score" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="5">
                                                                ...
                                                                <textarea readonly="" class="form-control" name="ff_remarks" id="ff_remarks"><?php echo $mRecord['ff_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
        ...
        <script>
            ...
            $('#ff_one').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_one_marks_label').html("Enter Score");
                }
            });
            ...
            $('#ff_two').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_two_marks_label').html("Enter Score");
                }
            });
            ...
            $('#ff_three').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_three_marks_label').html("Enter Score");
                }
            });
            ...
            $('#ff_four').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_four_marks_label').html("Enter Score");
                }
            });
            ...
            $('#ff_nine').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#ff_nine_marks_label').html("Enter Score");
                }
            });
            ...
            function calculateTotal(val) {
                ...
                var total = parseInt(first) + parseInt(second) + parseInt(third) + parseInt(fourth) + parseInt(fifth) + parseInt(sixth) + parseInt(seven) + parseInt(eight) + parseInt(nine);
