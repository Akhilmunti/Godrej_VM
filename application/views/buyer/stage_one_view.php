                                            ...
                                            <div class="row"> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input disabled required="" type="text" class="form-control required" id="turnovlast3y" name="turn_over_of_last_3years" value="<?php echo $stageOne['turn_over_of_last_3years']; ?>" placeholder="Average Turn Over for Last 3 yrs (In Crores)"> </div>
                                                </div> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6" >
                                                    ...
                                                    <div id="interested_zones">
                                                        ...
                                                        <div class="form-check form-check-inline" id="eastBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_5" value="Kolkata" name="interested_zones[]" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if ($stageOne['profile']) { ?>
                                                            <a href="<?php echo base_url('uploads/' . $stageOne['profile']); ?>" download="" class="btn btn-sm btn-primary">Download</a>
                                                        <?php } ?>
                                                    </div>
                                                </div> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wlastName2"> PAN :</label>
                                                        <input disabled type="text" class="form-control" id="pan" name="pan" value="<?php echo $stageOne['pan']; ?>"> 
                                                    </div>
                                                </div>
                                            </div>
