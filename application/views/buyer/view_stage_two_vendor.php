                                                ...
                                                <div class="row"> 
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" class="form-control required" id="websiteA" name="sitesVisitA" placeholder="http://" value="
                                                            <?php
                                                            if (!empty($getStageTwo)) {
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required" id="websiteB" name="sitesVisitB" placeholder="http://" value=" <?php
                                                            if (!empty($getStageTwo)) {
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required" id="websiteC" name="sitesVisitC" placeholder="http://" value=" <?php
                                                            if (!empty($getStageTwo)) {
