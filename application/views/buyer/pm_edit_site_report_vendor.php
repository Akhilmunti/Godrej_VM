                                    ...
                                    <div class="box-body pb-0">
                                        ...
                                        <form method="POST" action="<?php echo base_url('buyer/vendor/actionSaveSvr/' . $mVendorData['id'] . "/" . $mRecord['svr_id']); ?>" enctype="multipart/form-data">
                                                ...
                                                <table style="text-transform: capitalize !important" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" required="" class="form-control" name="svr_quality_end" id="svr_quality_end">
                                                                    <option value="" required="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input disabled="" value="<?php echo $mRecord['svr_quality_end_score']; ?>" required="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svr_quality_end_score" id="svr_quality_end_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svr_quality_end_remarks"><?php echo $mRecord['svr_quality_end_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <textarea  disabled="" placeholder="Remarks" rows="5" class="form-control" name="svrc_remarks" id="svr_remarks"><?php echo $mRecord['svr_remarks']; ?></textarea>
                                                <br>
                                            </div>
