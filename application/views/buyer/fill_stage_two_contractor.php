...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-blueindigo onlyheader">
        ...
        <!--                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[9]; ?>" type="file" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control"/>-->
                                                                                    <?php if ($disable == "disabled" && $mScope[9]) { ?>
                                                                                        <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mScope[9]); ?>">Download</a>
                                                                                    <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "disabled" && $mRecord['stc_qap_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "disabled" && $mRecord['stc_9001_isoc_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "disabled" && $mRecord['stc_45001_isoc_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "disabled" && $mRecord['stc_oca_attach']) { ?>
                                                                                    <br>
