                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>" disabled="" type="text" name="svrc_contractor" class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['svrc_site_visited']; ?>" disabled="" type="text" name="svrc_site_visited"  class="form-control">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>" disabled="" type="text" name="svrc_nature"  class="form-control">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['svrc_assessor']; ?>" placeholder="Enter comma seperated values for multiple assessors" disabled="" type="text" name="svrc_assessor" class="form-control">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
<!--                                                                <input disabled="" type="file" name="svrc_assessor_attachment" class="form-control">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input value="<?php echo $mRecord['svrc_visit_date']; ?>" disabled="" type="date" name="svrc_visit_date"  class="form-control">
                                                            </td>
                                                        </tr>
                                                    </tbody>   
                                                </table>
                                                ...
                                                <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100" style="text-transform: uppercase !important">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_mob_setup" id="svrc_mob_setup">
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_mob_setup_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_mob_setup_score" id="svrc_mob_setup_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_mob_setup_remarks"><?php echo $mRecord['svrc_mob_setup_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_main" id="svrc_main">
                                                                    <option  value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_main_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_main_score" id="svrc_main_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_main_remarks"><?php echo $mRecord['svrc_main_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_quality" id="svrc_quality">
                                                                    <option value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_quality_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_quality_score" id="svrc_quality_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_quality_remarks"><?php echo $mRecord['svrc_quality_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_status" id="svrc_status">
                                                                    <option value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_status_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_status_score" id="svrc_status_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_status_remarks"><?php echo $mRecord['svrc_status_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_quality_mngmnt" id="svrc_quality_mngmnt">
                                                                    <option value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_quality_mngmnt_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_quality_mngmnt_score" id="svrc_quality_mngmnt_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_quality_mngmnt_remarks"><?php echo $mRecord['svrc_quality_mngmnt_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_safety_mngmt" id="svrc_safety_mngmt">
                                                                    <option value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_safety_mngmt_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_safety_mngmt_score" id="svrc_safety_mngmt_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_safety_mngmt_remarks"><?php echo $mRecord['svrc_safety_mngmt_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label></label>
                                                                <select disabled="" class="form-control" name="svrc_feedback" id="svrc_feedback">
                                                                    <option value="" disabled="" selected="">Select</option>
                                                                    <option <?php
                                                            ...
                                                            <td style="width: 200px">
                                                                ...
                                                                <input value="<?php echo $mRecord['svrc_feedback_score']; ?>" disabled="" onchange="calculateTotal(this.value)" type="number" class="form-control" name="svrc_feedback_score" id="svrc_feedback_score" />
                                                            </td>
                                                            <td>
                                                                <textarea disabled="" class="form-control" rows="4" name="svrc_feedback_remarks"><?php echo $mRecord['svrc_feedback_remarks']; ?></textarea>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input value="<?php echo $mRecord['svrc_final_score']; ?>" disabled="" disabled="" type="number" name="svrc_final_score" id="svrc_final_score" class="form-control">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2"></td>
                                                            ...
                                                            <td colspan="2">
                                                                <select disabled="" class="form-control" name="svrc_final_recommendation" id="svrc_final_recommendation">
                                            ...
                                            <table class="table table-bordered" style="text-transform: uppercase !important">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="3">
<!--                                                            <input type="file" name="svrc_photograph">-->
                                                            Photograph Upload
                                                        ...
                                                        <td colspan="3">
<!--                                                            <input type="file" name="svrc_video">-->
                                                            Video Upload
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
<!--                                                            <input type="file" name="svrc_evidence">-->
                                                        ...
                                                        <td colspan="3">
<!--                                                            <input type="file" name="svrc_others">-->
                                                            Any other Upload
                                            ...
                                            <textarea disabled=""  placeholder="Remarks" rows="5" class="form-control" name="svrc_remarks" id="svrc_remarks"><?php echo $mRecord['svrc_remarks']; ?></textarea>
                                            <br>
                                            <!--                                            <h6><b>QUALITY MANAGEMENT SYSTEM </b></h6>
                                                                                        <div class="table-responsive">
                                                                                            <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td rowspan="2">1</td>
                                                                                                        <td rowspan="2">Effective Safety management system and excellent safety record in place.</td>
                                                                                                        <td>1. Effective Safety Management System-Operational Controls  i.e. Safety Resources, Barricades, safety nets, Scaffolding. working platform, safe equipment & machineries, use of mandatory PPEs etc. in place.
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <label>Between 8-10</label>
                                                                                                            <input value="<?php echo $mRecord['svrc_rating_effective']; ?>" style="width: 90px" disabled="" min="8" max="10" type="number" name="svrc_rating_effective" class="form-control">
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <textarea class="form-control" rows="10" name="svrc_rating_effective_remarks"><?php echo $mRecord['svrc_rating_effective_remarks']; ?></textarea>
                                                                                                        </td>
                                            
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>2. Safety Record-Lagging indicators-Process of recording & investigation of incidents/occupational illness available, No major incident/illness reported and leading indicators available (Safe man-hours, Training, inspections, health awareness & motivational programs etc.)  </td>
                                            
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td rowspan="2">2</td>
                                                                                                        <td rowspan="2">Safety management system and process of safety record  is in place but  not adequate .</td>
                                                                                                        <td>1. Safety Management System-Operational Controls in place however not as per standard  i.e. nonqualified Safety Resources, non-standard Barricades, safety nets, bamboo Scaffolding. working platform, equipment & machineries without inspection, use of non-standard PPEs  etc. in place .
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <label>Between 4-7</label>
                                                                                                            <input value="<?php echo $mRecord['svrc_rating_safety_mngmt']; ?>" style="width: 90px" disabled="" min="4" max="7" type="number" name="svrc_rating_safety_mngmt" class="form-control">
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <textarea class="form-control" rows="10" name="svrc_rating_safety_mngmt_remarks"><?php echo $mRecord['svrc_rating_little_remarks']; ?></textarea>
                                                                                                        </td>
                                            
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>2. Safety Record--Recording of incidents/illness available but investigation & CAPA process not in place., leading indicators - through safety inspections, training and health awareness program conducted. there is no laid down process.  </td>
                                            
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td rowspan="2">3</td>
                                                                                                        <td rowspan="2">Little evidence of proper safety management and safety record .</td>
                                                                                                        <td>1. Safety Management System- No or inadequate operational Controls in place. No PPEs being used during work.
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <label>Between 0-3</label>
                                                                                                            <input value="<?php echo $mRecord['svrc_rating_little']; ?>" style="width: 90px" disabled="" min="0" max="3" type="number" name="svrc_rating_little" class="form-control">
                                                                                                        </td>
                                                                                                        <td rowspan="2">
                                                                                                            <textarea class="form-control" rows="10" name="svrc_rating_little_remarks"><?php echo $mRecord['svrc_rating_little_remarks']; ?></textarea>
                                                                                                        </td>
        ...
        <script>
            ...
            $('#svrc_mob_setup').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_mob_setup_score_label').html("Enter Score");
                }
            });
            ...
            $('#svrc_main').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_main_score_label').html("Enter Score");
                }
            });
            ...
            $('#svrc_quality').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_quality_score_label').html("Enter Score");
                }
            });
            ...
            $('#svrc_status').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_status_score_label').html("Between 8-10");
                } else if (selected == "2") {
                    $("#svrc_status_score").attr({
                        "max": 7,
                        "min": 4
                    });
                    $('#svrc_status_score_label').html("Between 4-7");
                } else if (selected == "3") {
                    $("#svrc_status_score").attr({
                        "max": 3,
                        "min": 1
                    });
                    $('#svrc_status_score_label').html("Between 1-3");
                } else if (selected == "4") {
                    $("#svrc_status_score").attr({
                        "max": 0,
                        "min": 0
                    });
                    $('#svrc_status_score_label').html("Enter Score");
                }
            });
            ...
            $('#svrc_quality_mngmnt').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_quality_mngmnt_score_label').html("Between 8-10");
                } else if (selected == "2") {
                    $("#svrc_quality_mngmnt_score").attr({
                        "max": 7,
                        "min": 4
                    });
                    $('#svrc_quality_mngmnt_score_label').html("Between 4-7");
                } else if (selected == "3") {
                    $("#svrc_quality_mngmnt_score").attr({
                        "max": 3,
                        "min": 1
                    });
                    $('#svrc_quality_mngmnt_score_label').html("Between 1-3");
                } else if (selected == "4") {
                    $("#svrc_quality_mngmnt_score").attr({
                        "max": 0,
                        "min": 0
                    });
                    $('#svrc_quality_mngmnt_score_label').html("Enter Score");
                }
            });
            ...
            $('#svrc_safety_mngmt').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_safety_mngmt_score_label').html("Between 8-10");
                    ...
                    $('#svrc_safety_mngmt_score_label').html("Between 4-7");
                    $('#svrc_final_recommendation').val("Go");
                    $('#svrc_final_recommendation').attr({
                        "readonly": false,
                    });
                    ...
                    $('#svrc_safety_mngmt_score_label').html("Between 1-3");
                    ...
                    $('#svrc_safety_mngmt_score_label').html("Enter Score");
                    $('#svrc_final_recommendation').val("NoGo");
                    $('#svrc_final_recommendation').attr({
                        "readonly": "readonly",
                    });
            ...
            $('#svrc_feedback').on('change', function () {
                ...
                if (selected == "1") {
                    ...
                    $('#svrc_feedback_score_label').html("Enter Score");
                }
            });
