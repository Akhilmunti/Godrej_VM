                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100" border="1px">
                                                    <thead class="bg-primary">
                                                        <tr>
                                                            <th>PROJECT NAME:</th>
                                                            <th rowspan="2"><input value="<?php echo $mRecord['csvr_project_name']; ?>" type="text" name="projectName" class="form-control"></th>
                                                            <th>DATE</th>
                                                            <th colspan="2"><input value="<?php echo $mRecord['csvr_date']; ?>" type="date" name="date" class="form-control"></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input value="10" type="text" name="consultant[]" class="form-control"></td>
                                                            <td>15</td>
                                                            <td><input value="8" type="number" name="rating[]" class="form-control" min="0"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>2</td>
                                                            <td>Number of projects currently handled by proposed team lead and total team strength</td>
                                                            <td><input value="5" type="text" name="consultant[]" class="form-control"></td>
                                                            <td>5</td>
                                                            <td><input value="5" type="number" name="rating[]" class="form-control" min="0"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>3</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input value="15" type="text" name="consultant[]" class="form-control"></td>
                                                            <td>15</td>
                                                            <td><input value="15" type="number" name="rating[]" class="form-control" min="0"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>5</td>
