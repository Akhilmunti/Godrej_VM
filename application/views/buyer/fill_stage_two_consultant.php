                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body wizard-content">
                                        ...
                                        <form id="register_form" action="<?php echo base_url('buyer/vendor/postStageTwoConsultant/' . $mRecord['stcon_id']); ?>" method="POST" class=" validation-wizard" enctype="multipart/form-data">
                                            <!-- step -->
                                            <h6></h6>
                                            <section>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control required" id="stcon_doi" name="stcon_doi" value="<?php
                                                            if (!empty($mRecord)) {
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            ?>"  <?php echo $disable; ?>>
                                                            <br><br>
                                                            <input type="file" name="stcon_gst_file" class="form-control"  <?php echo $disable; ?>/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required" id="stcon_pan" name="stcon_pan" value="<?php
                                                            if (!empty($mRecord)) {
                                                                echo $mRecord['stcon_pan'];
                                                            }
                                                            ?>" <?php echo $disable; ?>>
                                                            <br>
                                                            <input type="file" name="stcon_pan_file" class="form-control"  <?php echo $disable; ?>/>
                                                                ...
                                                                <tbody id="itemsTbody">
                                                                    <?php if (!empty($mRecord['stcon_wpc_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stcon_wpc_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[3]; ?>" type="date" name="stcon_wpc_details[<?php echo $mCount; ?>][]"  class="form-control"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[4]; ?>" type="date" name="stcon_wpc_details[<?php echo $mCount; ?>][]"  class="form-control"/>
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><input value="" type="text" name="stcon_wpc_details[1][]"  class="form-control"/></td>
                                                                            <td>
                                                                                <input value="" type="date" name="stcon_wpc_details[1][]"  class="form-control"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="date" name="stcon_wpc_details[1][]"  class="form-control"/>
                                                                            </td>
                                                                    ...
                                                                    <?php if (!empty($mRecord['stcon_dcw_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stcon_dcw_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[5]; ?>" type="date" name="stcon_dcw_details[<?php echo $mCount; ?>][]"  class="form-control"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="date" name="stcon_dcw_details[<?php echo $mCount; ?>][]"  class="form-control"/>
                                                                                </td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><input value="" type="number" name="stcon_dcw_details[1][]"  class="form-control"/></td>
                                                                            <td>
                                                                                <input value="" type="date" name="stcon_dcw_details[1][]"  class="form-control"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="date" name="stcon_dcw_details[1][]"  class="form-control"/>
                                                                            </td>
                                                            ...
                                                            <div class="box-body">
                                                                <div class="table-responsive-sm">
                                                                    ...
                                                                    <table class="table table-bordered table-separated">
                                                                        ...
                                                                        <tr> 
                                                                            <td>Year 1 (2019-2020)</td>
                                                                            <td>Year 2 (2020-2021)</td>
                                                                            <td>Year 3 (2021-2022)</td>
                                                                        </tr>
                                                                        <tr>
...
<?php } ?>
            ...
            $(document).ready(function () {
                ...
                $("#addrowscope").on("click", function () {
                    ...
                    cols += '<td><input type="text" class="form-control" name="stcon_wpc_details[' + counterscope + '][]"/></td>';
                    cols += '<td><input type="text" class="form-control" name="stcon_wpc_details[' + counterscope + '][]"/></td>';
                    cols += '<td><input type="date" class="form-control" name="stcon_wpc_details[' + counterscope + '][]"/></td></td>';
                    cols += '<td><input type="date" class="form-control" name="stcon_wpc_details[' + counterscope + '][]"/></td></td>';
                ...
                $("#addrowcc").on("click", function () {
                    ...
                    cols += '<td><input type="number" class="form-control" name="stcon_wpc_details[' + counterdcw + '][]"/></td>';
                    cols += '<td><input type="date" class="form-control" name="stcon_wpc_details[' + counterdcw + '][]"/></td></td>';
                    cols += '<td><input type="date" class="form-control" name="stcon_wpc_details[' + counterdcw + '][]"/></td></td>';
                    newRow.append(cols);
