                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body wizard-content">
                                        ...
                                        <form id="register_form" action="<?php echo base_url('vendor/home/updateStageTwoContractor'); ?>" method="POST" class=" validation-wizard" enctype="multipart/form-data">
                                            <!-- step -->
                                            <h6></h6>
                                            <section>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control required" id="stc_doi" name="stc_doi" value="<?php
                                                            if (!empty($mRecord)) {
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <br>
                                                            <input class="required" placeholder="Please click on enter to input multiple values" data-role="tagsinput" type="text" id="stc_gst" name="stc_gst" value="<?php
                                                            if (!empty($mRecord)) {
                                                            ...
                                                            <br><br>
                                                            <?php if ($disable == "") { ?>
                                                                <input type="file" name="stc_gst_file" class="form-control"  <?php echo $disable; ?>/>
                                                            <?php } ?>
                                                            <?php if ($disable == "" && $mRecord['stc_gst_file']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required" id="stc_pan" name="stc_pan" value="<?php
                                                            if (!empty($mRecord)) {
                                                            ...
                                                            <br>
                                                            <?php if ($disable == "") { ?>
                                                                <input type="file" name="stc_pan_file" class="form-control"  <?php echo $disable; ?>/>
                                                            <?php } ?>
                                                            <?php if ($disable == "" && $mRecord['stc_pan_file']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_epf" name="stc_epf" <?php echo $disable; ?>>
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_epf_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_esic" name="stc_esic" <?php echo $disable; ?>>
                                                                <option value="" disabled="" selected="">Select</option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_esic_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_lwf" name="stc_lwf" <?php echo $disable; ?>>
                                                                <option value="" disabled="" selected="">Select</option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_lwf_attach']) { ?>
                                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_ptrc" name="stc_ptrc" <?php echo $disable; ?>>
                                                                <option value="" disabled="" selected="">Select</option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_ptrc_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_secn" name="stc_secn" <?php echo $disable; ?>>
                                                                <option value="" disabled="" selected="">Select</option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_secn_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="stc_lin" name="stc_lin" <?php echo $disable; ?>>
                                                                <option value="" disabled="" selected="">Select</option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stc_lin_attach']) { ?>
                                                                <br>
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input style="width: 100%" required="true" class="form-control" type="date" id="stc_epf_six" name="stc_epf_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input style="width: 100%" required="true" class="form-control" type="date" id="stc_esic_six" name="stc_esic_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input style="width: 100%" required="true" class="form-control" type="date" id="stc_lwf_six" name="stc_lwf_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input style="width: 100%" required="true" class="form-control" type="date" id="stc_ptrc_six" name="stc_ptrc_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control required" id="stc_tel" name="stc_tel" value="<?php
                                                            if (!empty($mRecord)) {
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="required" placeholder="Please click on enter to input multiple values" data-role="tagsinput" type="text" class="form-control required" id="stc_eocp" name="stc_eocp" value="<?php
                                                            if (!empty($mRecord)) {
                                                                    ...
                                                                    <?php if (!empty($mRecord['stc_wpc_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stc_wpc_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[2]; ?>" type="number" name="stc_wpc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-3"/></td>
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[5]; ?>" type="date" onchange="getStartDate('<?php echo $mCount; ?>')" id="stc_wpc_details_sd_<?php echo $mCount; ?>" name="stc_wpc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-6"/>
                                                                                </td>
                                                                                <td>
        ...
        <!--                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[7]; ?>" type="file" name="stc_wpc_details[<?php echo $mCount; ?>][]"  class="form-control"/>-->
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            <td><a class="deleteRow"></a></td>
                                                                            <td>
                                                                                <input value="" type="text" name="stc_wpc_details[1][]" class="form-control required site-value"/>
                                                                            </td>
                                                                            <td><input value="" type="text" name="stc_wpc_details[1][]"  class="form-control required site-value-2"/></td>
                                                                            <td><input value="" type="number" name="stc_wpc_details[1][]"  class="form-control required site-value-3"/></td>
                                                                            <td><input value="" type="text" name="stc_wpc_details[1][]"  class="form-control required site-value-4"/></td>
                                                                            <td><input value="" type="number" name="stc_wpc_details[1][]"  class="form-control required site-value-5"/></td>
                                                                            <td>
                                                                                <input value="" type="date" name="stc_wpc_details[1][]" onchange="getStartDate('1')" id="stc_wpc_details_sd_1" class="form-control required site-value-6"/>
                                                                            </td>
                                                                            <td>
                                                                    ...
                                                                    <?php if (!empty($mRecord['stc_dcw_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stc_dcw_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                <td><a class="deleteRow"></a></td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[0]; ?>" type="text" name="stc_dcw_details[<?php echo $mCount; ?>][]" class="form-control site-value"/>
                                                                                </td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[1]; ?>" type="text" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-2"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[2]; ?>" type="number" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-3"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[3]; ?>" type="text" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-4"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[4]; ?>" type="text" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-5"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[5]; ?>" type="number" onchange="getOrderValue('<?php echo $mCount; ?>')" id="stc_dcw_details_ov_<?php echo $mCount; ?>" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-6"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="number" onchange="getBilledValue('<?php echo $mCount; ?>')" id="stc_dcw_details_bv_<?php echo $mCount; ?>" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-7"/></td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[7]; ?>" type="date" onchange="getDcwStartDate('<?php echo $mCount; ?>')" id="stc_dcw_details_sd_<?php echo $mCount; ?>" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control site-value-8"/>
                                                                                </td>
                                                                                <td>
        ...
        <!--                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[9]; ?>" type="file" name="stc_dcw_details[<?php echo $mCount; ?>][]"  class="form-control"/>-->
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input value="" type="text" name="stc_dcw_details[1][]" class="form-control site-value"/>
                                                                            </td>
                                                                            <td><input value="" type="text" name="stc_dcw_details[1][]"  class="form-control site-value-2"/></td>
                                                                            <td><input value="" type="number" name="stc_dcw_details[1][]"  class="form-control site-value-3"/></td>
                                                                            <td><input value="" type="text" name="stc_dcw_details[1][]"  class="form-control site-value-4"/></td>
                                                                            <td><input value="" type="text" name="stc_dcw_details[1][]"  class="form-control site-value-5"/></td>
                                                                            <td><input value="" type="number" name="stc_dcw_details[1][]" onchange="getOrderValue('1')" id="stc_dcw_details_ov_1" class="form-control site-value-6"/></td>
                                                                            <td><input value="" type="number" name="stc_dcw_details[1][]" onchange="getBilledValue('1')" id="stc_dcw_details_bv_1" class="form-control site-value-7"/></td>
                                                                            <td>
                                                                                <input value="" type="date" name="stc_dcw_details[1][]" onchange="getDcwStartDate('1')" id="stc_dcw_details_sd_1" class="form-control site-value-8"/>
                                                                            </td>
                                                                            <td>
                                                ...
                                                <br/>
                                                <h6><b> Timely Completion Certification/ from Customers in last 5 years : <span class="danger">*</span></b></h6>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <select class="custom-select form-control required" id="stc_cc" name="stc_cc" <?php echo $disable; ?>> 
                                                                ...
                                                                ?> value="1">Completion certificates more than 6  </option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                                    if ($mRecord['stc_cc'] == "2") {
                                                                        echo "selected";
                                                                ...
                                                                ?> value="2">Completion certificates between 3 - 5  </option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                                    if ($mRecord['stc_cc'] == "3") {
                                                                        echo "selected";
                                                                ...
                                                                ?> value="3">Completion certificates between 1 - 2 </option>
                                                                <option <?php
                                                                if (!empty($mRecord)) {
                                                                    if ($mRecord['stc_cc'] == "4") {
                                                                        echo "selected";
                                                                ...
                                                                ?> value="4">No Completion certificates</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="table-responsive"> 
                                                            <table id="stc_cc_table" class="table table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Action</th>
                                                                        <th>Name of Client</th>
                                                                ...
                                                                <tbody id="itemsTbody">
                                                                    <?php if (!empty($mRecord['stc_cc_details'])) { ?>
                                                                        <?php
                                                                        $mCount = 0;
                                                                        foreach (json_decode($mRecord['stc_cc_details']) as $key => $mScope) {
                                                                            $mCount++;
                                                                            ?>
                                                                            <tr>
                                                                                <td><a class="deleteRow"></a></td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[0]; ?>" type="text" name="stc_cc_details[<?php echo $mCount; ?>][]" class="form-control site-value"/>
                                                                                </td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[1]; ?>" type="text" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-2"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[2]; ?>" type="number" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-3"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[3]; ?>" type="text" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-4"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[4]; ?>" type="text" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-5"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[5]; ?>" type="number" onchange="getCcOrderValue('<?php echo $mCount; ?>')" id="stc_cc_details_ov_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-6"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="number" onchange="getCcBilledValue('<?php echo $mCount; ?>')" id="stc_cc_details_bv_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-7"/></td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[7]; ?>" type="date" onchange="getCcStartDate('<?php echo $mCount; ?>')" id="stc_cc_details_sd_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-8"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[8]; ?>" type="date" onchange="getCcStartDate('<?php echo $mCount; ?>')" id="stc_cc_details_ed_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-9"/>
                                                                                </td>
                                                                                <td>
        <!--                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[9]; ?>" type="file" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control"/>-->
                                                                                    <?php if ($disable == "" && $mScope[9]) { ?>
                                                                                        <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mScope[9]); ?>">Download</a>
                                                                                    <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            <td><a class="deleteRowCc"></a></td>
                                                                            <td>
                                                                                <input value="" type="text" name="stc_cc_details[1][]" class="form-control site-value"/>
                                                                            </td>
                                                                            <td><input value="" type="text" name="stc_cc_details[1][]"  class="form-control site-value-2"/></td>
                                                                            <td><input value="" type="number" name="stc_cc_details[1][]"  class="form-control site-value-3"/></td>
                                                                            <td><input value="" type="text" name="stc_cc_details[1][]"  class="form-control site-value-4"/></td>
                                                                            <td><input value="" type="text" name="stc_cc_details[1][]"  class="form-control site-value-5"/></td>
                                                                            <td><input value="" type="number" name="stc_cc_details[1][]" onchange="getCcOrderValue('1')" id="stc_cc_details_ov_1" class="form-control site-value-6"/></td>
                                                                            <td><input value="" type="number" name="stc_cc_details[1][]" onchange="getCcBilledValue('1')" id="stc_cc_details_bv_1" class="form-control site-value-7"/></td>
                                                                            <td>
                                                                                <input value="" type="date" name="stc_cc_details[1][]" onchange="getCcStartDate('1')" id="stc_cc_details_sd_1" class="form-control site-value-8"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="date" name="stc_cc_details[1][]" onchange="getCcStartDate('1')" id="stc_cc_details_ed_1" class="form-control site-value-9"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="file" name="stc_cc_details[1][]"  class="form-control site-value-10"/>
                                                                            </td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                            ...
                                            <section>
                                                ...
                                                <!--                                                <div class="row">
                                                                                                    <div class="col-md-12">
                                                                                                        <div class="controls">
                                                                                                            <fieldset>
                                                                                                                <input type="checkbox" id="checkbox_122" name="stc_qac[]" value="BOTH ISO: 9001 CERTIFIED & 45001 CERTIFIED"  
                                                <?php
                                                if (!empty($mRecord)) {
                                                    $data = json_decode($mRecord['stc_qac']);

                                                    if (in_array('BOTH ISO: 9001 CERTIFIED & 45001 CERTIFIED', $data)) {
                                                        echo'checked';
                                                    }
                                                }
                                                ?> <?php echo $disable; ?>>
                                                
                                                                                                                <label class="form-check-label" for="checkbox_122">BOTH ISO: 9001 CERTIFIED & 45001 CERTIFIED
                                                                                                                </label>
                                                
                                                                                                            </fieldset>
                                                                                                            <fieldset>
                                                                                                                <input class="form-check-input" type="checkbox" id="checkbox_123"  name="stc_qac[]" value="EITHER ISO 9001 OR 45001 CERTIFIED"  
                                                <?php
                                                if (!empty($mRecord)) {
                                                    $data = json_decode($mRecord['stc_qac']);

                                                    if (in_array('EITHER ISO 9001 OR 45001 CERTIFIED', $data)) {
                                                        echo'checked';
                                                    }
                                                }
                                                ?> <?php echo $disable; ?>>
                                                                                                                <label class="form-check-label" for="checkbox_123">EITHER ISO 9001 OR 45001 CERTIFIED</label>
                                                                                                            </fieldset>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                <fieldset>
                                                                                    <input onclick="checkThree(this);" <?php echo $disable; ?> name="stc_qap" type="radio" id="radio_1" value="Yes" 
                                                                                    <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_qap'] == 'Yes') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?>
                                                                                ...
                                                                                <fieldset>
                                                                                    <input onclick="checkThree(this);" <?php echo $disable; ?> name="stc_qap" type="radio" id="radio_2" value="No"
                                                                                    <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_qap'] == 'No') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?>
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stc_qap_attach']) { ?>
                                                                                    <br>
                                                                                    <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mRecord['stc_qap_attach']); ?>">Download</a>
                                                                                <?php } ?>

                                                                                <input style="width: 300px" type="file" hidden="true" class="form-control" name="stc_qap_attach" id="stc_qap_attach" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                <fieldset>
                                                                                    <input onclick="checkOne(this);" <?php echo $disable; ?> name="stc_9001_isoc" type="radio" id="radio_3" value="Yes" 
                                                                                    <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_9001_isoc'] == 'Yes') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?> >
                                                                                ...
                                                                                <fieldset>
                                                                                    <input onclick="checkOne(this);" <?php echo $disable; ?> name="stc_9001_isoc" type="radio" id="radio_4" value="No"
                                                                                    <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_9001_isoc'] == 'No') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?> >
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stc_9001_isoc_attach']) { ?>
                                                                                    <br>
                                                                                    <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mRecord['stc_9001_isoc_attach']); ?>">Download</a>
                                                                                <?php } ?>

                                                                                <input style="width: 300px" type="file" hidden="true" class="form-control" name="stc_9001_isoc_attach" id="stc_9001_isoc_attach" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                <fieldset>
                                                                                    <input onclick="checkTwo(this);" <?php echo $disable; ?> name="stc_45001_isoc" type="radio" id="radio_5" value="Yes"  <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_45001_isoc'] == 'Yes') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?> >
                                                                                ...
                                                                                <fieldset>
                                                                                    <input onclick="checkTwo(this);" <?php echo $disable; ?> name="stc_45001_isoc" type="radio" id="radio_6" value="No"<?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_45001_isoc'] == 'No') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?>>
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stc_45001_isoc_attach']) { ?>
                                                                                    <br>
                                                                                    <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mRecord['stc_45001_isoc_attach']); ?>">Download</a>
                                                                                <?php } ?>

                                                                                <input style="width: 300px"  type="file" hidden="true" class="form-control" name="stc_45001_isoc_attach" id="stc_45001_isoc_attach" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                <fieldset>
                                                                                    <input onclick="checkFour(this);" <?php echo $disable; ?> name="stc_oca" type="radio" id="radio_7" value="Yes"   <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_oca'] == 'Yes') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?>  >
                                                                                ...
                                                                                <fieldset>
                                                                                    <input onclick="checkFour(this);" <?php echo $disable; ?> name="stc_oca" type="radio" id="radio_8" value="No" <?php
                                                                                    if (!empty($mRecord)) {
                                                                                        if ($mRecord['stc_oca'] == 'No') {
                                                                                            echo "checked";
                                                                                        }
                                                                                    }
                                                                                    ?> >
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stc_oca_attach']) { ?>
                                                                                    <br>
                                                                                    <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mRecord['stc_oca_attach']); ?>">Download</a>
                                                                                <?php } ?>

                                                                                <input style="width: 300px"  type="file" hidden="true" class="form-control" name="stc_oca_attach" id="stc_oca_attach" />
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody id="sites-table-tbody">
                                                                <?php
                                                                $mSites = json_decode($mRecord['stc_visit_a']);
                                                                ?>
                                                                <?php
                                                                foreach ($mSites as $key => $mSite) {
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="checkbox">
                                                                                <input checked <?php echo $disable; ?> class="sites_checkbox" value="<?php echo $mSite; ?>" type="checkbox" name="stc_visit_a[]" id="stc_sites_visited<?php echo $key; ?>">
                                                                                <label for="stc_sites_visited<?php echo $key; ?>"></label>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <div class="checkbox">
                                                            <div class="checkbox">
                                                                <input <?php
                                                                if ($mRecord['stc_visit_b']) {
                                                                    echo "checked";
                                                                }
                                                                ?> <?php echo $disable; ?> type="checkbox" name="stc_others" id="stc_others">
                                                                <label for="stc_others">Others</label>
                                                            </div>
                                                        </div>

                                                        <?php if ($mRecord['stc_visit_b']) { ?>
                                                            <input <?php echo $disable; ?> type="text" class="form-control" id="websiteA" name="stc_visit_b"  value="<?php echo $mRecord['stc_visit_b']; ?>">
                                                        <?php } else { ?>
                                                            <input hidden="true" <?php echo $disable; ?> type="text" class="form-control" id="websiteA" name="stc_visit_b"  value="<?php echo $mRecord['stc_visit_b']; ?>">
                                                        <?php } ?>
                            ...
                            if (countStepsChange == "0") {
                                ...
                                $("#stc_wpc_table tbody tr").each(function () {
                                    ...
                                    if (currentRow.find(".site-value").val()) {
                                        $('#sites-table-tbody').append('<tr><td><div class="checkbox"><input class="sites_checkbox" value="' + currentRow.find(".site-value").val() + ", " + currentRow.find(".site-value-2").val() + ", " + currentRow.find(".site-value-3").val() + ", " + currentRow.find(".site-value-4").val() + ", Rs." + currentRow.find(".site-value-5").val() + " (In Crs) " + ", NA " + '" type="checkbox" name="stc_visit_a[]" id="stc_sites_visited' + stv_wpc_count + '"><label for="stc_sites_visited' + stv_wpc_count + '"></label></div></td><td>' + currentRow.find(".site-value").val() + '</td><td>' + currentRow.find(".site-value-2").val() + '</td><td>' + currentRow.find(".site-value-3").val() + '</td><td>' + currentRow.find(".site-value-4").val() + '</td><td>' + currentRow.find(".site-value-5").val() + '</td><td>' + " NA " + '</td></tr>');
                                    }
                                });
                                ...
                                $("#stc_dcw_table tbody tr").each(function () {
                                    ...
                                    var currentRow = $(this); //Do not search the whole HTML tree twice, use a subtree instead
                                    if (currentRow.find(".site-value").val()) {
                                        $('#sites-table-tbody').append('<tr><td><div class="checkbox"><input class="sites_checkbox" value="' + currentRow.find(".site-value").val() + ", " + currentRow.find(".site-value-2").val() + ", " + currentRow.find(".site-value-3").val() + ", " + currentRow.find(".site-value-4").val() + ", Rs." + currentRow.find(".site-value-6").val() + " (In Crs) " + ", Rs." + currentRow.find(".site-value-7").val() + " (In Crs) " + '" type="checkbox" name="stc_visit_a[]" id="stc_sites_visited' + stc_dcw_count + '"><label for="stc_sites_visited' + stc_dcw_count + '"></label></div></td><td>' + currentRow.find(".site-value").val() + '</td><td>' + currentRow.find(".site-value-2").val() + '</td><td>' + currentRow.find(".site-value-3").val() + '</td><td>' + currentRow.find(".site-value-4").val() + '</td><td>' + currentRow.find(".site-value-6").val() + '</td><td>' + currentRow.find(".site-value-7").val() + '</td></tr>');
                                    }
                                });
                                ...
                                $("#stc_cc_table tbody tr").each(function () {
                                    ...
                                    var currentRow = $(this); //Do not search the whole HTML tree twice, use a subtree instead
                                    if (currentRow.find(".site-value").val()) {
                                        $('#sites-table-tbody').append('<tr><td><div class="checkbox"><input class="sites_checkbox" value="' + currentRow.find(".site-value").val() + ", " + currentRow.find(".site-value-2").val() + ", " + currentRow.find(".site-value-3").val() + ", " + currentRow.find(".site-value-4").val() + ", Rs." + currentRow.find(".site-value-6").val() + " (In Crs) " + ", Rs." + currentRow.find(".site-value-7").val() + " (In Crs) " + '" type="checkbox" name="stc_visit_a[]" id="stc_sites_visited' + stc_cc_count + '"><label for="stc_sites_visited' + stc_cc_count + '"></label></div></td><td>' + currentRow.find(".site-value").val() + '</td><td>' + currentRow.find(".site-value-2").val() + '</td><td>' + currentRow.find(".site-value-3").val() + '</td><td>' + currentRow.find(".site-value-4").val() + '</td><td>' + currentRow.find(".site-value-6").val() + '</td><td>' + currentRow.find(".site-value-7").val() + '</td></tr>');
                                    }
                                });
                            }
                        }
...
<?php } ?>
            ...
            function getOrderValue(mRowId) {
                ...
                var billed = $('#stc_dcw_details_bv_' + mRowId).val();
                $('#stc_dcw_details_bv_' + mRowId).attr({
                    "max": order,
                });
            }

            function getCcStartDate(mRowId) {
                var start_date = $('#stc_cc_details_sd_' + mRowId).val();
                var end_date = $('#stc_cc_details_ed_' + mRowId).val();
                if (end_date) {
                    if (new Date(start_date).getTime() > new Date(end_date).getTime()) {
                        $('#stc_cc_details_ed_' + mRowId).attr({
                            "min": start_date,
                        });
                    }
                } else {
            ...
            function getCcOrderValue(mRowId) {
                var order = $('#stc_cc_details_ov_' + mRowId).val();
                var billed = $('#stc_cc_details_bv_' + mRowId).val();
                $('#stc_cc_details_bv_' + mRowId).attr({
                    "max": order,
                });
            }
            ...
            $(document).ready(function () {
                ...
                var counterscope = 2;
                var selectedWork = "<?php echo $mRecord['stc_wpc']; ?>";
                    ...
                    if (this.value === "1") {
                        ...
                        if (count < 11) {
                            ...
                            for (var i = 0; i < times; i++) {
                                ...
                                cols += '<td><input required type="date" onchange="getStartDate(' + counterscope + ')" id="stc_wpc_details_sd_' + counterscope + '" class="form-control site-value-6" name="stc_wpc_details[' + counterscope + '][]"/></td>';
                ...
                var counterdcw = 2;
                var selectedReg = "<?php echo $mRecord['stc_dcw']; ?>";
                $('#stc_dcw').on('change', function () {
                    ...
                    if (this.value === "1") {
                        ...
                        for (var i = 0; i < times; i++) {
                            ...
                            cols += '<td><input required type="number" class="form-control site-value-3" name="stc_dcw_details[' + counterdcw + '][]"/></td>';
                            cols += '<td><input required type="text" class="form-control site-value-4" name="stc_dcw_details[' + counterdcw + '][]"/></td>';
                            cols += '<td><input required type="text" class="form-control site-value-5" name="stc_dcw_details[' + counterdcw + '][]"/></td>';
                ...
                var countercc = 2;
                var selectedCc = "<?php echo $mRecord['stc_cc']; ?>";
                $('#stc_cc').on('change', function () {
                    ...
                    if (this.value === "1") {
                        ...
                        for (var i = 0; i < times; i++) {
                            ...
                            cols += '<td><input required type="text" class="form-control site-value-2" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="number" class="form-control site-value-3" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="text" class="form-control site-value-4" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="text" class="form-control site-value-5" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="number" class="form-control site-value-6" onchange="getCcOrderValue(' + countercc + ')" id="stc_cc_details_ov_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="number" class="form-control site-value-7" onchange="getCcBilledValue(' + countercc + ')" id="stc_cc_details_bv_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="date" class="form-control site-value-8" onchange="getCcStartDate(' + countercc + ')" id="stc_cc_details_sd_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="date" class="form-control site-value-9" onchange="getCcEndDate(' + countercc + ')" id="stc_cc_details_ed_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="file" class="form-control site-value-10" name="stc_cc_details[' + countercc + '][]"/></td>';
                            newRow.append(cols);
...
<?php if ($disable == "") { ?>
                ...
                var stc_doi = "<?php echo $mRecord['stc_doi']; ?>";
                var date1 = new Date(stc_doi);
                var date2 = new Date();
                var Difference_In_Time = date2.getTime() - date1.getTime();
                var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24 * 365);
