<header class="main-header">
    ...
    <a href="#" class="logo">
        <!-- mini logo -->
        <div class="logo-mini">
            <span class="light-logo"><img src="<?php echo base_url('assets/'); ?>images/godrej-logo-feedback.png" alt="logo"></span>
            <span class="dark-logo"><img src="<?php echo base_url('assets/'); ?>images/godrej-logo-feedback.png" alt="logo"></span>
        </div>
        <!-- logo-->
        <div class="logo-lg">
            <span class="light-logo"><img src="<?php echo base_url('assets/'); ?>images/godrej-logo-feedback.png" alt="logo"></span>
...
<!--                <li class="search-bar d-sm-inline-flex d-none">		  
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        ...
                        <li class="user-header bg-img" style="background-image: url(<?php echo base_url('assets/'); ?>images/user-info.jpg)" data-overlay="3">
                            <div class="flexbox align-self-center">					  
                                ...
                                <h4 class="user-name align-self-center">
                                    <span>
                                        <?php echo $this->session->userdata('session_vendor_name'); ?>
                                    </span>
                                    <small>
                                        <?php echo $this->session->userdata('session_vendor_email'); ?>
                                    </small>
                                </h4>
                            </div>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                            <a class="dropdown-item" href="<?php echo base_url('vendor/home/logout'); ?>"><i class="ion-log-out"></i> Logout</a>
                        </li>
                    </ul>
                </li>
