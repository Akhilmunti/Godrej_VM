    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <div class="media-list media-list-hover media-list-divided">
                <div class="media">
                    <img class="avatar avatar-lg" src="<?php echo base_url('assets/'); ?>images/avatar/1.jpg" alt="...">
                ...
                <div class="media">
                    <img class="avatar avatar-lg" src="<?php echo base_url('assets/'); ?>images/avatar/2.jpg" alt="...">
