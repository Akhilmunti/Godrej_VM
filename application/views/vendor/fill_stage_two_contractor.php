                                                                    ...
                                                                    <?php if (!empty($mRecord['stc_cc_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stc_cc_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input max="<?php echo date("Y-m-d"); ?>" <?php echo $disable; ?> value="<?php echo $mScope[7]; ?>" type="date" onchange="getCcStartDate('<?php echo $mCount; ?>')" id="stc_cc_details_sd_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-8"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input max="<?php echo date("Y-m-d"); ?>" <?php echo $disable; ?> value="<?php echo $mScope[8]; ?>" type="date" onchange="getCcStartDate('<?php echo $mCount; ?>')" id="stc_cc_details_ed_<?php echo $mCount; ?>" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-9"/>
                                                                                </td>
                                                                                <td>
        <!--                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[9]; ?>" type="file" name="stc_cc_details[<?php echo $mCount; ?>][]"  class="form-control"/>-->
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input max="<?php echo date("Y-m-d"); ?>" value="" type="date" name="stc_cc_details[1][]" onchange="getCcStartDate('1')" id="stc_cc_details_sd_1" class="form-control site-value-8"/>
                                                                            </td>
                                                                            <td>
                                                                                <input max="<?php echo date("Y-m-d"); ?>" value="" type="date" name="stc_cc_details[1][]" onchange="getCcStartDate('1')" id="stc_cc_details_ed_1" class="form-control site-value-9"/>
                                                                            </td>
                                                                            <td>
                ...
                $('#stc_cc').on('change', function () {
                    ...
                    if (this.value === "1") {
                        ...
                        for (var i = 0; i < times; i++) {
                            ...
                            cols += '<td><input max="<?php echo date("Y-m-d"); ?>" required type="date" class="form-control site-value-8" onchange="getCcStartDate(' + countercc + ')" id="stc_cc_details_sd_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input max="<?php echo date("Y-m-d"); ?>" required type="date" class="form-control site-value-9" onchange="getCcEndDate(' + countercc + ')" id="stc_cc_details_ed_' + countercc + '" name="stc_cc_details[' + countercc + '][]"/></td>';
