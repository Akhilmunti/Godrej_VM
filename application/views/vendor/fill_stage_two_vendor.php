                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input max="<?php echo date("Y-m-d"); ?>" type="date" class="form-control required" id="stv_doi" name="stv_doi" value="<?php
                                                            if (!empty($mRecord)) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="" type="text" class="form-control required" id="stv_pan" name="stv_pan" value="<?php
                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input max="<?php echo date("Y-m-d"); ?>" style="width: 100%" required="true" class="form-control" type="date" id="stv_epf_six" name="stv_epf_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input max="<?php echo date("Y-m-d"); ?>" style="width: 100%" required="true" class="form-control" type="date" id="stv_esic_six" name="stv_esic_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input max="<?php echo date("Y-m-d"); ?>" style="width: 100%" required="true" class="form-control" type="date" id="stv_lwf_six" name="stv_lwf_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                            ...
                                                                            <table class="table">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input max="<?php echo date("Y-m-d"); ?>" style="width: 100%" required="true" class="form-control" type="date" id="stv_ptrc_six" name="stv_ptrc_six" value="<?php
                                                                                            if (!empty($mRecord)) {
                                                                ...
                                                                <tbody id="itemsTbody">
                                                                    <?php if (!empty($mRecord['stv_scope_of_work'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stv_scope_of_work']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input max="<?php echo date("Y-m-d"); ?>" <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="date" name="stv_scope_of_work[<?php echo $mCount; ?>][]"  class="form-control site-value-7"/>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <input max="<?php echo date("Y-m-d"); ?>" <?php echo $disable; ?> value="<?php echo $mScope[8]; ?>" type="date" name="stv_scope_of_work[<?php echo $mCount; ?>][]"  class="form-control site-value-9"/>
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input max="<?php echo date("Y-m-d"); ?>" value="" type="date" name="stv_scope_of_work[1][]" onchange="getStartDate('1')" id="stv_scope_of_work_sd_1" class="form-control site-value-7"/>
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <input max="<?php echo date("Y-m-d"); ?>" value="" type="date" name="stv_scope_of_work[1][]" onchange="getEndDate('1')" id="stv_scope_of_work_ed_1" class="form-control site-value-9"/>
                                                                            </td>
                                                                            <td>
                    ...
                    if (this.value === "1") {
                        ...
                        if (count < 12) {
                            ...
                            for (var i = 0; i < times; i++) {
                                ...
                                cols += '<td><input max="<?php echo date("Y-m-d"); ?>" required type="date" class="form-control site-value-7" onchange="getStartDate(' + counterscope + ')" id="stv_scope_of_work_sd_' + counterscope + '" name="stv_scope_of_work[' + counterscope + '][]"/></td>';
                                ...
                                cols += '<td><input max="<?php echo date("Y-m-d"); ?>" required type="date" class="form-control site-value-9" onchange="getEndDate(' + counterscope + ')" id="stv_scope_of_work_ed_' + counterscope + '" name="stv_scope_of_work[' + counterscope + '][]"/></td>';
