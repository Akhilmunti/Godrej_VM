                                                                ...
                                                                <tbody id="itemsTbody">
                                                                    <?php if (!empty($mRecord['stc_wpc_details'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stc_wpc_details']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="date" onchange="getEndDate(<?php echo $mCount; ?>)" id="stc_wpc_details_sd_<?php echo $mCount; ?>" name="stc_wpc_details[<?php echo $mCount; ?>][]"  class="form-control site-value-7"/>
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input value="" type="date" onchange="getStartDate('1')" id="stc_wpc_details_sd_1" name="stc_wpc_details[1][]"  class="form-control site-value-6"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="date" onchange="getEndDate('1')" id="stc_wpc_details_ed_1" name="stc_wpc_details[1][]"  class="form-control site-value-7"/>
                                                                            </td>
                                                                            <td>
                                                                ...
                                                                <tbody id="itemsTbody">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input value="" type="date" name="stc_dcw_details[1][]" onchange="getDcwStartDate('1')" id="stc_dcw_details_sd_1" class="form-control site-value-dcw-8"/>
                                                                            </td>
                                                                            <td>
                                                                                <input value="" type="date" name="stc_dcw_details[1][]" onchange="getDcwEndDate('1')" id="stc_dcw_details_ed_1" class="form-control site-value-dcw-9"/>
                                                                            </td>
                                                                            <td>
...
<?php } ?>
            ...
            $(document).ready(function () {
                ...
                var counterscope = $('#stc_wpc_table tr').length;
                ...
                var counterdcw = $('#stc_dcw_table tr').length;
                ...
                $('#stc_dcw').on('change', function () {
                    ...
                    if (this.value === "1") {
                        ...
                        for (var i = 0; i < times; i++) {
                            ...
                            cols += '<td><input required type="date" onchange="getDcwStartDate(' + counterdcw + ')" id="stc_dcw_details_sd_' + counterdcw + '" class="form-control site-value-dcw-8" name="stc_dcw_details[' + counterdcw + '][]"/></td>';
                            cols += '<td><input required type="date" onchange="getDcwEndDate(' + counterdcw + ')" id="stc_dcw_details_ed_' + counterdcw + '" class="form-control site-value-dcw-9" name="stc_dcw_details[' + counterdcw + '][]"/></td>';
                ...
                $('#stc_cc').on('change', function () {
                    ...
                    if (this.value === "1") {
                        ...
                        for (var i = 0; i < times; i++) {
                            ...
                            cols += '<td><input required type="number" class="form-control" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="number" class="form-control" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="date" class="form-control" name="stc_cc_details[' + countercc + '][]"/></td>';
                            cols += '<td><input required type="date" class="form-control" name="stc_cc_details[' + countercc + '][]"/></td>';
