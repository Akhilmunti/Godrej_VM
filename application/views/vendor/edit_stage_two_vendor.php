                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body wizard-content">
                                        ...
                                        <form id="register_form" action="<?php echo base_url('vendor/home/updateStageTwoVendor'); ?>" method="POST" class="validation-wizard" enctype="multipart/form-data">
                                            <!-- step -->
                                            <h6></h6>
                                            <section>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            ?>"  <?php echo $disable; ?>>
                                                            <br><br>
                                                            <input type="file" name="stv_gst_file" class="form-control"  <?php echo $disable; ?>/>
                                                            <?php if ($disable == "" && $mRecord['stv_gst_file']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            ?>" <?php echo $disable; ?>>
                                                            <br>
                                                            <input type="file" name="stv_pan_file" class="form-control"  <?php echo $disable; ?>/>
                                                            <?php if ($disable == "" && $mRecord['stv_pan_file']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_epf_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_esic_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_lwf_attach']) { ?>
                                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_ptrc_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_secn_attach']) { ?>
                                                                <br>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($disable == "" && $mRecord['stv_lin_attach']) { ?>
                                                                <br>
                                                                    ...
                                                                    <?php if (!empty($mRecord['stv_scope_of_work'])) { ?>
                                                                        ...
                                                                        foreach (json_decode($mRecord['stv_scope_of_work']) as $key => $mScope) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[0]; ?>" type="text" name="stv_scope_of_work[<?php echo $key; ?>][]" class="form-control site-value"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[1]; ?>" type="text" name="stv_scope_of_work[<?php echo $key; ?>][]" class="form-control site-value-2"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[2]; ?>" type="number" name="stv_scope_of_work[<?php echo $key; ?>][]" class="form-control site-value-3"/>
                                                                                </td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[3]; ?>" type="text" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-4"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[4]; ?>" type="text" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-5"/></td>
                                                                                <td><input <?php echo $disable; ?> value="<?php echo $mScope[5]; ?>" type="number" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-6"/></td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[6]; ?>" type="date" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-7"/>
                                                                                </td>
                                                                                <td>
                                                                                    <select <?php echo $disable; ?> class="form-control table-select site-value-8" name="stv_scope_of_work[<?php echo $key; ?>][]">
                                                                                ...
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[8]; ?>" type="date" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-9"/>
                                                                                </td>
                                                                                <td>
                                                                                    <input <?php echo $disable; ?> value="<?php echo $mScope[9]; ?>" type="number" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-10"/>
                                                                                </td>
                                                                                <td>
                                                                                    <?php if ($disable == "" && $mScope[10]) { ?>
                                                                                        <input value="" type="file" name="stv_scope_of_work[<?php echo $key; ?>][]"  class="form-control site-value-11"/>
...
<!--                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input style="width: 200px" <?php echo $disable; ?> type="file" name="stv_fin_uploads[]" value="<?php echo $mFinUploads[0]; ?>">
                                                                        <?php if ($disable == "" && $mFinUploads[0]) { ?>
                                                                            <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mFinUploads[0]); ?>">Download</a>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td>
                                                                        <input style="width: 200px" <?php echo $disable; ?> type="file" name="stv_fin_uploads[]" value="<?php echo $mFinUploads[1]; ?>">
                                                                        <?php if ($disable == "" && $mFinUploads[1]) { ?>
                                                                            <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mFinUploads[1]); ?>">Download</a>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td>
                                                                        <input style="width: 200px" <?php echo $disable; ?> type="file" name="stv_fin_uploads[]" value="<?php echo $mFinUploads[2]; ?>">
                                                                        <?php if ($disable == "" && $mFinUploads[2]) { ?>
                                                                            <a class="btn btn-sm btn-info" download="" href="<?php echo base_url('uploads/' . $mFinUploads[2]); ?>">Download</a>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td>
                                                                        <input style="width: 200px" <?php echo $disable; ?> type="file" name="stv_fin_uploads[]" value="<?php echo $mFinUploads[3]; ?>">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stv_qap_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stv_9001_isoc_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stv_45001_isoc_attach']) { ?>
                                                                                    <br>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="controls">
                                                                                ...
                                                                                <?php if ($disable == "" && $mRecord['stv_oca_attach']) { ?>
                                                                                    <br>
...
<?php } ?>
            ...
            $(document).ready(function () {
                ...
                var counterscope = $('#stv_scope_of_work_table tr').length;
                var selectedWork = <?php echo $mRecord['stv_rwgd']; ?>;
...
<?php if ($disable == "") { ?>
                ...
                var stv_9001_isoc = "<?php echo $mRecord['stv_9001_isoc']; ?>";
                if (stv_9001_isoc == "Yes") {
                    $("#stv_9001_isoc_attach").attr({
                        "hidden": false,
                        "required": false
                    });
                ...
                var stv_45001_isoc = "<?php echo $mRecord['stv_45001_isoc']; ?>";
                if (stv_45001_isoc == "Yes") {
                    $("#stv_45001_isoc_attach").attr({
                        "hidden": false,
                        "required": false
                    });
                ...
                var stv_qap = "<?php echo $mRecord['stv_qap']; ?>";
                if (stv_qap == "Yes") {
                    $("#stv_qap_attach").attr({
                        "hidden": false,
                        "required": false
                ...
                var stv_oca = "<?php echo $mRecord['stv_oca']; ?>";
                if (stv_oca == "Yes") {
                    $("#stv_oca_attach").attr({
                        "hidden": false,
                        "required": false
                ...
                var stv_doi = "<?php echo $mRecord['stv_doi']; ?>";
                var date1 = new Date(stv_doi);
                var date2 = new Date();
                var Difference_In_Time = date2.getTime() - date1.getTime();
                var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24 * 365);
