                            ...
                            <div class="col-12">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body wizard-content">
                                        <form id="register_form" action="<?php echo base_url('home/getProjectManagementConsultant');?>" method="POST"  class=" validation-wizard wizard-circle">  <h6></h6>
                                            <section>
                                                <div class="row">
                                                    <div class="col-md-12">
