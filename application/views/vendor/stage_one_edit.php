                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select required="" class="form-control" name="typeOfWork">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="text" class="form-control required" id="wfirstName2" name="company_name" value="<?php echo $stageOne['company_name']; ?>"> </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wlastName2"> User Name : <span class="danger">*</span> </label>
                                                        <input required="" type="text" class="form-control required" id="wlastName2" name="user_name" value="<?php echo $stageOne['user_name']; ?>"> </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="email" class="form-control required" id="wemailAddress2" name="email" value="<?php echo $stageOne['email']; ?>"> </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wlastName2">Phone Number : <span class="danger">*</span></label>
                                                        <input required="" type="tel" class="form-control required" id="phno" name="contact_number" value="<?php echo $stageOne['contact_number']; ?>"> </div>
                                                </div>
                                            </div>
                                            <div class="row"> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="number" class="form-control required" id="turnovlast3y" name="turn_over_of_last_3years" value="<?php echo $stageOne['turn_over_of_last_3years']; ?>" placeholder="Average Turn Over for Last 3 yrs (In Crores)"> </div>
                                                </div> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6" >
                                                    ...
                                                    <div id="interested_zones">
                                                        ...
                                                        <div class="form-check form-check-inline" id="ncrBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_1" name="interested_zones[]" value="NCR">
                                                        ...
                                                        <div class="form-check form-check-inline" id="mumbaiBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_2" value="Mumbai" name="interested_zones[]">
                                                        ...
                                                        <div class="form-check form-check-inline" id="puneBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_3" value="Pune" name="interested_zones[]">
                                                        ...
                                                        <div class="form-check form-check-inline" id="southBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_4" value="South" name="interested_zones[]">
                                                        ...
                                                        <div class="form-check form-check-inline" id="eastBlock">
                                                            ...
                                                            ?> class="form-check-input" type="checkbox" id="checkbox_5" value="East" name="interested_zones[]">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea required="" class="form-control required" id="address" name="clientele" value=""><?php echo $stageOne['clientele']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wfirstName2"> Registered Address (Agency) : <span class="danger">*</span> </label>
                                                        <textarea required="" class="form-control required" id="address" name="address" value=""><?php echo $stageOne['address']; ?></textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $stageOne['city_name']; ?>" required="" type="text" class="form-control required" id="wLocation2" name="city_name">
                                                    </div>    
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wlastName2"> Website :</label>
                                                        <input type="text" class="form-control" id="website" name="website" value="<?php echo $stageOne['website']; ?>"> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
