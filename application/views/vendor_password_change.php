                        ...
                        <div class="col-xl-6 col-lg-7 col-md-6 col-12">
                            <div class="bg-opacity-90 depth-4 rounded">
                                ...
                                <div class="p-30">
                                    ...
                                    <form action="<?php echo base_url('home/actionSetPassword/' . $vendor_id); ?>" method="post">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text "><i class="ti-user"></i></span>
                                                </div>
                                                <input required type="password" class="form-control pl-15  plc-black" name="password" value="" placeholder="Password">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <input required type="password" class="form-control pl-15  plc-black" name="cpassword" value="" placeholder="Confirm Password">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" id="sign" class="btn btn-info btn-block">Submit</button>
                                        </div>
