                    ...
                    <div class="row l-block p-xl-100 p-lg-50 p-30 h-lg-p100 h-auto">
                        <div class="col-12 logo align-self-start">
                            <a href="#" class="aut-logo">
                                <img src="<?php echo base_url('assets/'); ?>images/logo-properties.png" alt="">
                            </a>
                        </div>
                                ...
                                <div class="p-30">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input required="" type="text" class="form-control pl-15  plc-black" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input required="" type="password" class="form-control pl-15  plc-black" placeholder="Password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input checked="" class="form-check-input" type="radio" name="inlineRadioOptions"  id="inlineRadio1" value="1">
...
<script type="text/javascript">
    ...
    $('#sign').click(function () {
        ...
        if ($("input[name='inlineRadioOptions']:checked").val() == 1) {
            ...
            window.location = "<?php echo base_url('home/stageOne'); ?>";
        } else {
