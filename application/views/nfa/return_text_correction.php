                ...
                <section class="content">
                      ...
                      <!-- <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="d-block">
                                <h3 class="page-title br-0">Return NFA(Text Correction) - LD Waiver</h3>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="box">
                        <div class="box-body">
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/ldWaiver/actionReturnText/'. $mRecord['id']); ?>" >
