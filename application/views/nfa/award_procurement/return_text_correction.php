            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h3 class="page-title br-0">Return IOM(Text Correction) - Award Recommendation for Procurement</h3>
                            </div>
						...
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/award_procurement/actionReturnText/'. $mRecord['id']); ?>" >
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary border-secondary font-weight-bold" name="return_text">Return IOM</button>
