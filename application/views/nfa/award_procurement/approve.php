                ...
                <section class="content">
                    ...
                    <!-- <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="d-block">
                                <h3 class="page-title br-0">Approve IOM - LD Waiver</h3>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h3 class="page-title br-0">Approve IOM - Award Recommendation for Procurement</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
							<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/award_procurement/actionApprove/'. $mRecord['id']); ?>" >
