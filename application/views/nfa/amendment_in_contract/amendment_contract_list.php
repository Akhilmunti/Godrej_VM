                        ...
                        <div class="col-12">
                            ...
                            <div class="box box-default">
                                <div class="box-body pb-0">
									...
									$current_page = base_url('nfa/amendment_in_contract/award_recomm_contract_list');
                                        ...
                                        <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                            ...
                                            <tbody class='text-center'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('nfa/amendment_in_contract/view_nfa/'. $record['id']); ?>">
                                                            <button type="button" class="btn btn-primary rounded buttonPadding">View</button>
                                                        </a>
														
                                                        <a href="<?php echo base_url('nfa/amendment_in_contract/actionEdit/' . $record['id']); ?>">
                                                            <button type="button" class="btn btn-success rounded buttonPadding ml-2">Edit</button>
                                                        </a>
														<a href="<?php echo base_url('nfa/amendment_in_contract/cancel/'.$record['id']); ?>">
