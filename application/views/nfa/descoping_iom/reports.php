        ...
        <div class="content-wrapper">
            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-body">
							<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/reports'); ?>" >
							<div class="row">
                                        <div class="col-lg-6">
 ...
 /* $(document).ready(function(){  
      $('#create_excel').click(function(){  
		  ...
		  //alert(excel_data);	
		   ...
		   $.post("<?php echo base_url('nfa/Award_contract/export_csv'); ?>",
					{
						data1: excel_data,
						//contract_value:$('#original_contract_value').val()
					},
...
$("#export_button").click(function(){
	...
	$.ajax({
		type: 'POST',
		url: "<?php echo base_url('nfa/BidderListContractor/export_csv'); ?>",
