            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="page-title br-0">Return NFA(Text Correction) - Short Listing Approval for Contractor</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/actionReturnText/'. $mRecord['id']); ?>" >
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class='form-group'>
                                        ...
                                        <input type="text" class="form-control h-50" placeholder="" name="returned_text_remarks" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary border-secondary font-weight-bold" name="return_text">Return NFA</button>
