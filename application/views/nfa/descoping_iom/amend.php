            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="page-title br-0">Ammend NFA - Short Listing Approval for Contractor</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/actionAmendNfa/'. $mRecord['id']); ?>" >
