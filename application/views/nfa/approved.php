            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="page-title br-0">Approved NFA's</h3>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody class='text-center'>
											 <?php if (!empty($records)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('nfa/LdWaiver/view/'. $record['id']."/A"); ?>">
                                                            <button type="button" class="btn btn-primary rounded buttonPadding">View</button>
                                                        </a>
                                                        <a href="<?php echo base_url('nfa/LdWaiver/amend_nfa/'. $record['id']); ?>">
                                                            <button type="button" class="btn btn-danger rounded ml-2 buttonPadding">Ammend</button>
                                                        </a>
														<a href="<?php echo base_url('nfa/LdWaiver/view/'. $record['id']."/E"); ?>">
