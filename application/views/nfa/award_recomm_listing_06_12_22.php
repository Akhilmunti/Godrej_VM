...
<div class="row mt-4">
<?php if($mSessionRole=="MD" || $mSessionRole=="COO" || $mSessionRole=="HO - C&P" || $mSessionRole=="HO" || $mSessionRole=="Zonal CEO"|| $mSessionRole=="RH"|| $mSessionRole=="OH"|| $mSessionRole=="PD"|| $mSessionRole=="CH"|| $mSessionRole=="Regional C&P Head"|| $mSessionRole=="Regional C&P Team")
{
?>
    <div class="col-lg-3">
