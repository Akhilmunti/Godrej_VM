							...
							<div class="d-block mt-4 mb-4">
								...
								<div class="row">
									<div class="col-lg-12 text-right">
										...
										<button type="submit" name="save" value="save" class="btn btn-outline-dark border-secondary mr-10 font-weight-bold">Save</button>
										<button type="submit" name="submit" value="submit" class="btn btn-outline-dark border-secondary font-weight-bold">Submit</button>
									</div>
								</div>
