            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="page-title br-0">Returned NFA's - Short Listing Approval For Contractor</h3>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody class='text-center'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url('nfa/BidderListContractor/actionEdit/' . $record['id']."/RF"); ?>">
