                            ...
                            <form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/actionSave/' . $mRecordBidContract['salient_id']); ?>" enctype="multipart/form-data" onsubmit="loader()">
								...
								<div class="row mt-4">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" oninput="allowNumOnly(this);decimalStrict()" class="form-control decimalStrictClass onMouseOutClass" placeholder="" name="budget_without_escalation" id="budgetWithoutEsc" onblur="levels_approvers(this);changeToCr(this)" value="<?php echo $mRecordBidContract['budget_without_escalation'].' Cr' ?>" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Budget with Escalation (In crores) * </label>
                                        <input type="text" oninput="allowNumOnly(this);decimalStrict()" class="form-control decimalStrictClass onMouseOutClass" placeholder="" name="budget_with_escalation" id="budgetWithEsc" onblur="levels_approvers(this);changeToCr(this)" value="<?php echo $mRecordBidContract['budget_with_escalation'].' Cr' ?>" required>
                                    </div>
                                    <!-- <div class="col-lg-8">
                                ...
                                <div class="row mt-20">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control pull-right" name="free_material" id="free_material" value="<?php echo $mRecordBidContract['free_material'] ?>" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Basic Rate Items*</label>
                                        <input type="text" class="form-control pull-right" name="basic_rate_items" id="basic_rate_items" value="<?php echo $mRecordBidContract['basic_rate_items'] ?>" required>
                                    </div>
                                </div>
                                        ...
                                        <tbody id="bidderList">
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td><input type="text" oninput="allowNumOnly(this);decimalStrict()" onblur="changeToCr(this)" class="form-control decimalStrictClass onMouseOutClass" placeholder="" name="avg_turn_over[]" id="avg_turn_over" value="<?php echo $avg_turn_over; ?>" required></td>
                                                    <td><input type="text" oninput="allowNumOnly(this);decimalStrict()" onblur="changeToCr(this)" class="form-control decimalStrictClass onMouseOutClass" placeholder="" name="bid_capacity[]" id="bid_capacity" value="<?php echo $bid_capacity; ?>" required></td>
                                                    ...
                                                    <td><input type="text" class="form-control" placeholder="" style="width: 120px !important;" name="ongoing_complete_project[]" id="ongoing_complete_project" value="<?php echo $ongoing_complete_project; ?>" required></td>
                                                    <td>
														<?php if($cnt != 0){ ?>
								...
								<table id="s_milestone_table2" class="table table-bordered  <?php echo $sho_key_table; ?> mt-4">
                                    <thead class="bg-primary">
                                        <tr>
                                            ...
                                            <th colspan="2">
                                                <input id="milestone_label" name="milestone_label" placeholder="Logic" class="form-control form-control-sm" type="text" value="<?php echo $mRecordBidContract['milestone_label']; ?>" required/>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th> Activity </th>
                                    ...
                                    <tbody>
										 ...
										 <tr> 
											<td>Planned date of Contractor appointment As per BI Logic.</td>
											<td><input type="date" class="form-control" placeholder="" id="activity_planned_date" name="activity_planned_date" value="<?php echo $mRecordBidContract['activity_planned_date']; ?>" required></td>
											<td>
												<textarea class="form-control" rows="2" name="activity_planned_remarks" id="activity_planned_remarks"><?php echo $mRecordBidContract['activity_planned_remarks']; ?></textarea>
											</td>
											<td></td>
										 ...
										 <tr> 
											<td>Actual date as per current site progress</td>
											<td><input type="date" class="form-control" placeholder="" id="activity_actual_date" name="activity_actual_date" value="<?php echo $mRecordBidContract['activity_actual_date']; ?>" required></td>
											<td>
												<textarea class="form-control" rows="2" name="activity_actual_remarks" id="activity_actual_remarks"><?php echo $mRecordBidContract['activity_actual_remarks']; ?></textarea>
											</td>
											<td></td>
										...
										<tr>
											<td>CBE of contractor Appointment</td>
											<td><input type="date" class="form-control" placeholder="" id="activity_cbe_date" name="activity_cbe_date" onblur="calculateDays();" value="<?php echo $mRecordBidContract['activity_cbe_date']; ?>" required></td>
											<td>
												<textarea class="form-control" rows="2" name="activity_cbe_remarks" id="activity_cbe_remarks"><?php echo $mRecordBidContract['activity_cbe_remarks']; ?></textarea>
											</td>
											<td></td>
                                    ...
                                    <table class="table mb-0 table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="date" class="form-control" placeholder="" name="receipt_date" id="receipt_date" value="<?php echo $mRecordBidContract['receipt_date']; ?>" required></td>
                                                <td><input type="date" class="form-control" placeholder="" name="bidder_approval_date" id="bidder_approval_date" value="<?php echo $mRecordBidContract['bidder_approval_date']; ?>" onblur="calBidderAppDays();" required ></td>
                                                <td><input type="date" class="form-control" placeholder="" name="award_recomm_date" id="award_recomm_date" value="<?php echo $mRecordBidContract['award_recomm_date']; ?>" onblur="calBidderAwdRecDays();" required></td>
                                                <td>
