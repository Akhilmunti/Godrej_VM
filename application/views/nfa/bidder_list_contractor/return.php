            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="page-title br-0">Return NFA - Short Listing Approval For Contractor</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/actionReturnNfa/'. $mRecord['id']); ?>" >
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class='form-group'>
                                        ...
                                        <input type="text" class="form-control h-50" placeholder="" name="returned_remarks" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
