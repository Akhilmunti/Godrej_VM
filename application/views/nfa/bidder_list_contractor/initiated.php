            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="page-title br-0">Current NFA's  - Short Listing Approval For Contractor</h3>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody class='text-center'>
											 <?php if (!empty($records)) { ?>
                                                        ...
                                                        foreach ($records as $key => $record) {
															...
															if($approver_level>1)
																$preChkRecords = $CI->nfaAction->chkPreApproved($salient_id,$approver_level,"bidder_contract");
															else
																$preChkRecords=1;
												...
												<?php 
		$data['mId']=$record['id'];
		$data['title']="Short Listing Approval For Contractor";
		$data['url']="nfa/BidderListContractor";
		//$this->load->vars($mid);
