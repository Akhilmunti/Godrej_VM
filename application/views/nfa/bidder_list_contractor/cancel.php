            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="page-title br-0">Cancel NFA - Short Listing Approval for Contractor</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
						<form id="nfaForm" method="POST" action="<?php echo base_url('nfa/BidderListContractor/actionCancelNfa/'. $mRecord['id']); ?>" >
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-12 text-right">
                                   <?php /* <a href="<?php echo base_url('nfa/BidderListContractor/list'); ?>"> <?php */?>
