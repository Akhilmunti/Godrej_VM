            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="page-title br-0">Approve NFA - Short Listing Approval for Supplier</h3>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
							<form id="nfaForm" onsubmit="loader()"  method="POST" action="<?php echo base_url('nfa/BidderListSupplier/actionApprove/'. $mRecord['id']); ?>" >
