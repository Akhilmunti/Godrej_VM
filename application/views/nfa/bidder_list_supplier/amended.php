            ...
            <div class="container-full clearfix position-relative">
                ...
                <section class="content">
                    ...
                    <div class="content-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="page-title br-0">Amended NFA's - Short Listing Approval for Supplier</h3>
                            </div>
                        </div>
                    </div>
											 ...
											 <?php if (!empty($records)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url('nfa/BidderListSupplier/actionEdit/'. $record['id']."/AMD"); ?>">
