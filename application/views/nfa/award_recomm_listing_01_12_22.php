    ...
    <div class="col-lg-12">
        ...
        { ?>
            <div>
                <a href="<?php echo base_url('nfa/Award_contract/actionAdd/' . $hd_project_id . "/$hd_zone/$hd_type_work_id" ); ?>">
                    <button type="button" style="width:25%;" class="btn btn-primary rounded">Create IOM</button>
                </a>
            </div>
        <?php 
        }
        ...
        <div>
            <a href="<?php echo base_url('nfa/Award_contract/reports')?>">
                <button type="button" style="width:25%;" class="btn btn-primary rounded">IOM Reports</button>
            </a>
        </div>
    </div>
</div>
...
if($mSessionRole=="MD" || $mSessionRole=="COO" || $mSessionRole=="HO - C&P" || $mSessionRole=="HO" || $mSessionRole=="Zonal CEO"|| $mSessionRole=="RH"|| $mSessionRole=="OH"|| $mSessionRole=="PD"|| $mSessionRole=="CH"|| $mSessionRole=="Regional C&P Head"|| $mSessionRole=="Regional C&P Team")
{
?>
    <div class="col-lg-3">
...
<div class="row ">
    ...
    <input type="hidden" name="hd_awdType" id="hd_awdType" value="<?php echo $hd_awdType ?>">
